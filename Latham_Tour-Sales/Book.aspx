...
<div class="jumbotron text-left">
    ...
    <p> Name:
        ...
        <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName" CssClass="alert-danger" ErrorMessage="Name is required."></asp:RequiredFieldValidator>
    </p>
    <p> Email:
        <asp:TextBox ID="txtEmail" runat="server" Width="306px" CssClass="text-md-left"></asp:TextBox>
        <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtEmail" CssClass="alert-danger" ErrorMessage="Email is required."></asp:RequiredFieldValidator>
    </p>
    <p> Adventure Package:
        ...
        <asp:RequiredFieldValidator ID="ddlAdventurePackage" runat="server" ControlToValidate="ddlPackage" CssClass="alert-danger" ErrorMessage="Adventure Package is required."></asp:RequiredFieldValidator>
    </p>
